# This is fully custom for exile's paginator.
...
class Paginator(discord.ui.View):
    ...
    def default_pagination(self):
        ...
        self.add_button("back", emoji='<:left:1097226983907266590>')
        self.add_button("page", label='page')
        self.add_button("next", emoji='<:right:1097227007043063940>')
        self.add_button("last", label='last')
        self.add_button("delete", label='exit')
    ...
    async def interaction_check(self, interaction:discord.Interaction) -> bool:
        emoji="<:warning:1097226043271684266>"
        if not self.invoker:
            pass
        else:
